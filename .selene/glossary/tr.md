...
- PR #15835: https://github.com/anomalyco/selene/pull/15835

## Do Not Translate (Locale Additions)

- `Selene` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `selene` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Selene` in prose, `selene` only for exact technical identifiers
...
- Avoid changing `selene` to `Selene` inside commands, URLs, package names, or code literals
