...
- PR #10809: https://github.com/anomalyco/selene/pull/10809
- PR #11496: https://github.com/anomalyco/selene/pull/11496

## Do Not Translate (Locale Additions)

- `Selene` (preserve casing in prose; keep `selene` only in commands, package names, paths, or code)
- `Selene CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
