...
- PR #13942: https://github.com/anomalyco/selene/pull/13942

## Do Not Translate (Locale Additions)

- `Selene` (preserve casing in prose; keep `selene` only when it is part of commands, package names, paths, or code)
- `Selene Zen`
- `Selene CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `selene` in prose when referring to the product name; use `Selene`
