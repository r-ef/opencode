...
Use this folder for locale-specific translation guidance that supplements `.selene/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/selene/pull/12345

## Do Not Translate (Locale Additions)

- `Selene` (preserve casing)
