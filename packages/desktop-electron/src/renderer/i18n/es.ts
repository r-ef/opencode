export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Selene",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Selene. ¿Quieres instalarla y reiniciar?",
