...
import compareVideo from "../../asset/lander/selene-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/selene-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="selene:auth" content={loggedin() ? "true" : "false"} />
