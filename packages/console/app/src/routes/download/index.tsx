...
import desktopAppIcon from "../../asset/lander/selene-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://selene.run/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>selene.run/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g selene-ai")}>
                <code>
                  npm i -g <strong>selene-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g selene-ai")}>
                <code>
                  bun add -g <strong>selene-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/selene")}>
                <code>
                  brew install <strong>anomalyco/tap/selene</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S selene")}>
                <code>
                  paru -S <strong>selene</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask selene-desktop")}>
                <code>
                  brew install --cask <strong>selene-desktop</strong>
                </code>
                <CopyStatus />
              </button>
