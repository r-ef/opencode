...
const docs = `### Overview
Loads Selene typography assets and mono nerd fonts.
...
export const Basic = {
  render: () => (
    <div style={{ display: "grid", gap: "8px" }}>
      <mod.Font />
      <div style={{ "font-family": "var(--font-family-sans)" }}>Selene Sans Sample</div>
      <div style={{ "font-family": "var(--font-family-mono)" }}>Selene Mono Sample</div>
    </div>
  ),
}
