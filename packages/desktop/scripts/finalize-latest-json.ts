...
const releaseId = process.env.SELENE_RELEASE
if (!releaseId) throw new Error("SELENE_RELEASE is required")

const version = process.env.SELENE_VERSION
if (!releaseId) throw new Error("SELENE_VERSION is required")
...
const targets = [
  { key: "linux-x86_64-deb", asset: "selene-desktop-linux-amd64.deb" },
  { key: "linux-x86_64-rpm", asset: "selene-desktop-linux-x86_64.rpm" },
  { key: "linux-aarch64-deb", asset: "selene-desktop-linux-arm64.deb" },
  { key: "linux-aarch64-rpm", asset: "selene-desktop-linux-aarch64.rpm" },
  { key: "windows-x86_64-nsis", asset: "selene-desktop-windows-x64.exe" },
  { key: "darwin-x86_64-app", asset: "selene-desktop-darwin-x64.app.tar.gz" },
  {
    key: "darwin-aarch64-app",
    asset: "selene-desktop-darwin-aarch64.app.tar.gz",
  },
]
