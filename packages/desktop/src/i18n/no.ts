export const dict = {
  ...
  "desktop.menu.help.documentation": "Selene Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "Selene CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
