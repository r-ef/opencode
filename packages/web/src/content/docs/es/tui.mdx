---
title: TUI
description: Usando la interfaz de usuario del terminal Selene.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Selene proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar Selene se inicia TUI para el directorio actual.
...
Cuando utilice Selene TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a Selene. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de Selene. _Alias_: `/quit`, `/q`
...
Esto es independiente de `selene.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `SELENE_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
