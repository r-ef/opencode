...
Puede agregar comandos personalizados a través de la configuración Selene o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Selene [config](/docs/config):
...
selene incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
