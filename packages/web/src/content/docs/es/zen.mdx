---
title: Zen
description: Lista seleccionada de modelos proporcionada por Selene.
---
...
Selene Zen es una lista de modelos probados y verificados proporcionada por el equipo Selene.

:::note
Selene Zen se encuentra actualmente en versión beta.
:::

Zen funciona como cualquier otro proveedor en Selene. Inicias sesion en Selene Zen y obtienes
tu API key. Es **completamente opcional** y no necesitas usarlo para usar Selene.
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con Selene.
:::
...
Selene Zen es una puerta de enlace de IA que le brinda acceso a estos modelos.

---

## Cómo funciona

Selene Zen funciona como cualquier otro proveedor en Selene.

1. Inicias sesión en **<a href={console}>Selene Zen</a>**, agregas tu facturación
   detalles y copie su clave API.
2. Ejecuta el comando `/connect` en TUI, selecciona Selene Zen y pega tu clave API.
...
El [model ID](/docs/config/#models) en tu configuracion de Selene
usa el formato `selene/<model-id>`. Por ejemplo, para GPT 5.2 Codex, debes
usar `selene/gpt-5.2-codex` en tu configuracion.
...
- MiniMax M2.5 Free está disponible en Selene por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo sigiloso gratuito en Selene por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. **No tener ningún bloqueo** al permitirle usarlo con cualquier otro agente de codificación. Y siempre le permitirá utilizar cualquier otro proveedor con Selene también.
