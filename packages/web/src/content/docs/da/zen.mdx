---
title: Zen
description: Udvalgt liste over modeller leveret af Selene.
---
...
Selene Zen er en liste over testede og verificerede modeller leveret af Selene-teamet.

:::note
Selene Zen er i øjeblikket i beta.
:::

Zen fungerer som alle andre udbydere i Selene. Du logger på Selene Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, der fungerer godt med Selene.
:::
...
Selene Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

Selene Zen fungerer som alle andre udbydere i Selene.

1. Du logger på **<a href={console}>Selene Zen</a>**, tilføjer faktureringsoplysninger
   og kopierer API-nøglen.
2. Du kører kommandoen `/connect` i TUI, vælger Selene Zen og indsætter API-nøglen.
...
| MiniMax M2.5 Gratis | minimax-m2.5-free  | `https://selene.run/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
...
| Kimi K2 Tenker      | kimi-k2-thinking   | `https://selene.run/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2             | kimi-k2            | `https://selene.run/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Qwen3-koder 480B    | qwen3-coder        | `https://selene.run/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Stor sylteagurk     | big-pickle         | `https://selene.run/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |

[model-id](/docs/config/#models) i Selene-konfigurationen
bruger formatet `selene/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruge `selene/gpt-5.2-codex` i din konfiguration.
...
- MiniMax M2.5 Gratis er tilgængelig på Selene i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- Stor sylteagurk er en stealth-model som er gratis på Selene i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
...
Vi oprettede Selene Zen for at:
...
4. Have **ingen fastlåsning** ved at lade dig bruge den med en hvilken som helst anden kodeagent. Og lade dig altid bruge en hvilken som helst anden udbyder med Selene også.
