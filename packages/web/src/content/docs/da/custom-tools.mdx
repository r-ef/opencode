...
description: Opret værktøjer, som LLM kan kalde selene ind.
---
...
- Lokalt ved at placere dem i biblioteket `.selene/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/selene/tools/`.
