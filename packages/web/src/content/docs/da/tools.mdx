...
Her er alle de innebygde verktøyene som er tilgængelige i Selene.
...
:::note
Dette verktøyet er bare tilgængelig når `SELENE_EXPERIMENTAL_LSP_TOOL=true` (eller `SELENE_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger Selene-leverandøren eller når miljøvariabelen `SELENE_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
