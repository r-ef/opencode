...
Du kan tilføje brugerdefinerede kommandoer gennem Selene-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din Selene [config](/docs/config):
...
- Globalt: `~/.config/selene/commands/`
- Pr. projekt: `.selene/commands/`
...
selene indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
