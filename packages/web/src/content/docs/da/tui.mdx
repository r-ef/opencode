---
title: TUI
description: Brug af Selene-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Selene giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Selene starter TUI for den nuværende mappe.
...
Når du bruger Selene TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Selene. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Selene. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `selene.json`, som konfigurerer server-/kørselstidsadfærd.
...
Brug `SELENE_TUI_CONFIG` til at indlæse en brugerdefineret TUI-konfigurationssti.
