---
title: TUI
description: استخدام واجهة المستخدم TUI في Selene.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Selene واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Selene إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Selene في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Selene. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Selene. _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات Selene.
...
استخدم `SELENE_TUI_CONFIG` لتحميل مسار إعدادات TUI مخصص.
