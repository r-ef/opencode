...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في selene.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في selene مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.selene/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/selene/tools/`.
