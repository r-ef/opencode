...
يوجد نوعان من الوكلاء في Selene: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي Selene مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي Selene مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي Selene مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `selene.json`:
...
- عام: `~/.config/selene/agents/`
- لكل مشروع: `.selene/agents/`
...
إذا لم يتم تحديد temperature، يستخدم Selene القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات Selene العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات Selene الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [Selene Zen](/docs/zen)، فستستخدم `selene/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `selene models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/anomalyco/selene).
:::
