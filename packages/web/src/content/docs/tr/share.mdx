---
title: Paylasim
description: selene konusmalarini genel baglantilarla paylasin.
---

selene'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda selene:
...
selene, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak selene manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `selene.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda selene kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
