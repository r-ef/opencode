...
`.selene/commands/test.md` oluştur:
...
selene işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

selene [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/selene/commands/`
- Proje başına: `.selene/commands/`
...
selene, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
