...
description: selene dile özgü biçimlendiriciler kullanır.
---

selene, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

selene, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, selene bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

selene bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri selene yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
