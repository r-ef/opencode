---
title: Özel Araçlar
description: LLM'un selene'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. selene'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.selene/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/selene/tools/` içine yerleştirerek.
