---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez Selene.
---
...
Selene Zen to lista przetestowanych i zweryfikowanych modeli udostępniona przez zespół Selene.

:::note
Selene Zen jest obecnie w wersji beta.
:::

Zen działa jak każdy inny dostawca w Selene. Logujesz się do Selene Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z Selene.
:::
...
Selene Zen to brama AI, która zapewnia dostęp do tych modeli.

---

## Jak to działa

Selene Zen działa jak każdy inny dostawca w Selene.

1. Logujesz się do **<a href={console}>Selene Zen</a>**, dodajesz dane rozliczeniowe
   i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz Selene Zen i wklejasz klucz API.
...
[Identyfikator modelu](/docs/config/#models) w konfiguracji Selene
używa formatu `selene/<model-id>`. Na przykład w przypadku GPT 5.2 Codex użyłbyś
`selene/gpt-5.2-codex` w swojej konfiguracji.
...
- MiniMax M2.5 Free jest dostępny w Selene przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Big Pickle to ukryty model, który jest bezpłatny w Selene przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
...
4. Nie **mieć blokady** (no lock-in), umożliwiając używanie go z dowolnym innym agentem kodującym. I zawsze pozwalać na korzystanie z dowolnego innego dostawcy w Selene.
