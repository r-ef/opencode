...
Utwórz `.selene/commands/test.md`:
...
Możesz zdefiniować polecenia w `selene.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji selene:
...
- Globalnie: `~/.config/selene/commands/`
- Na projekt: `.selene/commands/`
...
selene zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
