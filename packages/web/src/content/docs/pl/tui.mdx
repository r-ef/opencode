---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala selene.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

selene zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie selene uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI selene, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do selene. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij selene. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `selene.json`, który konfiguruje zachowanie serwera/runtime.
...
Użyj `SELENE_TUI_CONFIG`, aby załadować niestandardową ścieżkę konfiguracji TUI.
