---
title: Zen
description: Lista selecionada de modelos fornecidos pelo Selene.
---
...
O Selene Zen é uma lista de modelos testados e verificados fornecidos pela equipe do Selene.

:::note
O Selene Zen está atualmente em beta.
:::

O Zen funciona como qualquer outro provedor no Selene. Você faz login no Selene Zen e obtém sua chave de API. É **completamente opcional** e você não precisa usá-lo para utilizar o Selene.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o Selene.
:::
...
O Selene Zen é um gateway de IA que lhe dá acesso a esses modelos.

---

## Como funciona

O Selene Zen funciona como qualquer outro provedor no Selene.

1. Você faz login no **<a href={console}>Selene Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona Selene Zen e cola sua chave de API.
...
O [id do modelo](/docs/config/#models) na sua configuração do Selene usa o formato `selene/<model-id>`. Por exemplo, para GPT 5.2 Codex, você usaria `selene/gpt-5.2-codex` na sua configuração.
...
- MiniMax M2.5 Free está disponível no Selene por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo oculto que está gratuito no Selene por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
...
4. Não ter **vinculação** permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o Selene também.
