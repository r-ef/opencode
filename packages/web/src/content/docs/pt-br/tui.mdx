---
title: TUI
description: Usando a interface de usuário de terminal selene.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O selene fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar selene inicia o TUI para o diretório atual.
...
Ao usar o TUI do selene, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao selene. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do selene. _Aliases_: `/quit`, `/q`
...
Isso é separado do `selene.json`, que configura o comportamento do servidor/runtime.
...
Use `SELENE_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.
