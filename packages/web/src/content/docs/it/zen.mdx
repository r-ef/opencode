---
title: Zen
description: Lista curata di modelli fornita da Selene.
---
...
Selene Zen e una lista di modelli testati e verificati dal team di Selene.

:::note
Selene Zen e attualmente in beta.
:::

Zen funziona come qualunque altro provider in Selene. Accedi a Selene Zen e ottieni la tua chiave API. E **completamente opzionale**: non devi usarlo per usare Selene.
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con Selene.
:::
...
Selene Zen e un gateway AI che ti da accesso a questi modelli.

---

## Come funziona

Selene Zen funziona come qualunque altro provider in Selene.

1. Accedi a **<a href={console}>Selene Zen</a>**, aggiungi i dettagli di fatturazione e copia la chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona Selene Zen e incolla la chiave API.
...
Il [model id](/docs/config/#models) nella config di Selene usa il formato `selene/<model-id>`. Per esempio, per GPT 5.2 Codex useresti `selene/gpt-5.2-codex` nella config.
...
- MiniMax M2.5 Free e disponibile su Selene per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Big Pickle e un modello stealth gratuito su Selene per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
...
4. Evitare **lock-in** permettendoti di usarlo con qualunque altro agente di coding e lasciandoti sempre usare anche altri provider con Selene.
