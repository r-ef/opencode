...
Puoi aggiungere comandi personalizzati tramite la config di Selene o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Selene:
...
- Globale: `~/.config/selene/commands/`
- Per progetto: `.selene/commands/`
...
selene include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
