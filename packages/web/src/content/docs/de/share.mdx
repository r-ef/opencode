---
title: Teilen
description: Teile Selene-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Selene-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Selene Folgendes:
...
Selene hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Selene den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`selene.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du selene in deiner Organisation einsetzt.
