---
title: TUI
description: Arbeite mit Selene in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Selene bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet Selene die TUI im aktuellen Verzeichnis.
...
In der Selene-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu Selene hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet Selene. _Aliase_: `/quit`, `/q`
...
Dies ist getrennt von `selene.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `SELENE_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
