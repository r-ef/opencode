...
Erstellen Sie `.selene/commands/test.md`:

```md title=".selene/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Selene-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Selene [config](/docs/config):

```json title="selene.jsonc" {4-12}
{
...
- Global: `~/.config/selene/commands/`
- Pro Projekt: `.selene/commands/`

```markdown title="~/.config/selene/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".selene/commands/component.md"
---
...
```md title=".selene/commands/create-file.md"
---
...
```md title=".selene/commands/analyze-coverage.md"
---
...
```md title=".selene/commands/review-changes.md"
---
...
```md title=".selene/commands/review-component.md"
---
...
Selene enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
