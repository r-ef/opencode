---
title: TUI
description: Korištenje korisničkog interfejsa Selene terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Selene pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Selene pokreće TUI za trenutni direktorij.
...
Kada koristite Selene TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Selene. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Selene. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `selene.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `SELENE_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
