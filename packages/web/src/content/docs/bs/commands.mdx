...
Kreiraj `.selene/commands/test.md`:
...
Možete dodati prilagođene komande kroz Selene konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Selene [config](/docs/config):
...
- Globalno: `~/.config/selene/commands/`
- Po projektu: `.selene/commands/`
...
Selene uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
