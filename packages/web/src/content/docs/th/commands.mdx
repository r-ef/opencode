...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Selene:
...
- ระดับผู้ใช้ (Global): `~/.config/selene/commands/`
- ระดับโปรเจ็กต์: `.selene/commands/`
...
Selene มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
