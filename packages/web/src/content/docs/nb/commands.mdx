...
Opprett `.selene/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Selene-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Selene [config](/docs/config):
...
Selene inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
