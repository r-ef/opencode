...
Agentferdigheter lar Selene oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går selene opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
selene viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `selene.json`:
