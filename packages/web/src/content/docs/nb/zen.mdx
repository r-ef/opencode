---
title: Zen
description: Utvalgt liste over modeller levert av Selene.
---
...
Selene Zen er en liste over testede og verifiserte modeller levert av Selene-teamet.

:::note
Selene Zen er for øyeblikket i beta.
:::

Zen fungerer som alle andre leverandører i Selene. Du logger på Selene Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med Selene.
:::
...
Selene Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

Selene Zen fungerer som alle andre leverandører i Selene.

1. Du logger på **<a href={console}>Selene Zen</a>**, legg til fakturering
   detaljer, og kopier API-nøkkelen.
2. Du kjører kommandoen `/connect` i TUI, velger Selene Zen og limer inn API-nøkkelen.
...
[modell-id](/docs/config/#models) i Selene-konfigurasjonen
bruker formatet `selene/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruk `selene/gpt-5.2-codex` i konfigurasjonen din.
...
- MiniMax M2.5 Free er tilgjengelig på Selene i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på Selene i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
...
4. Ha **ingen låsing** ved å la deg bruke den med en hvilken som helst annen kodeagent. Og la deg alltid bruke en hvilken som helst annen leverandør med Selene også.
