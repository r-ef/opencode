---
title: TUI
description: Bruke selene-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Selene gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Selene starter TUI for gjeldende katalog.
...
Når du bruker Selene TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Selene. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Selene. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `selene.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `SELENE_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
