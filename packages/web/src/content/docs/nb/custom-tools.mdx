...
description: Lag verktøy som LLM kan kalle inn Selene.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med Selene sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.selene/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/selene/tools/`.
