...
export const SessionRoutes = lazy(() =>
  new Hono()
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific Selene session.",
        tags: ["Session"],
    ...
    .get(
      ...
      describeRoute({
        ...
        tags: ["Session"],
        description: "Retrieve all subagent sessions owned by the specified parent session.",
    ...
    .get(
      ...
      describeRoute({
        ...
        tags: ["Session"],
        description: "Retrieve all interactive sessions that share the same branch family and context root.",
        operationId: "session.branches",
        responses: {
          200: {
      ...
      validator(
        "param",
        z.object({
          sessionID: Session.branches.schema,
        }),
      ),
      async (c) => {
        const sessionID = c.req.valid("param").sessionID
        const session = await Session.branches(sessionID)
        return c.json(session)
      },
    )
    .get(
      ...
      describeRoute({
        summary: "Get shared context status",
        description: "Retrieve the shared-context cursor and publication status for a session within its root tree.",
        operationId: "session.contextStatus",
        responses: {
          200: {
            description: "Shared context status",
            content: {
              "application/json": {
                schema: resolver(Session.ContextStats),
              },
            },
          },
          ...errors(400, 404),
      ...
      async (c) => {
        ...
        const query = c.req.valid("query")
        const result = await Session.contextStats({
    ...
    .get(
      ...
      describeRoute({
        ...
        responses: {
          200: {
            description: "Shared context entries",
            content: {
              "application/json": {
                schema: resolver(Session.ContextInfo.array()),
              },
            },
          },
          ...errors(400, 404),
      ...
      async (c) => {
        const params = c.req.valid("param")
        const query = c.req.valid("query")
        const result = await Session.contextList({
          session_id: params.sessionID,
          after: query.after,
          limit: query.limit,
          source_session_id: query.source_session_id,
    ...
    .post(
      "/:sessionID/context/reconcile",
      describeRoute({
        summary: "Reconcile shared context",
        description:
          "Publish an authoritative reconciliation entry for one or more shared-context updates, for example when sibling tasks disagree.",
        operationId: "session.contextReconcile",
        responses: {
          200: {
            description: "Reconciliation entry",
            content: {
              "application/json": {
                schema: resolver(Session.ContextInfo),
              },
            },
          },
          ...errors(400, 404),
      ...
      validator("json", Session.contextReconcile.schema.omit({ session_id: true })),
      async (c) => {
        const sessionID = c.req.valid("param").sessionID
        const body = c.req.valid("json")
        const result = await Session.contextReconcile({
          session_id: sessionID,
          ...body,
        })
        return c.json(result)
    ...
    .post(
      ...
      describeRoute({
        ...
        responses: {
          200: {
            ...
            content: {
              "application/json": {
                schema: resolver(Session.ContextTrim),
              },
            },
          },
          ...errors(400, 404),
      ...
      validator("json", Session.contextTrim.schema.omit({ session_id: true }).optional()),
      async (c) => {
        const sessionID = c.req.valid("param").sessionID
        const body = c.req.valid("json") ?? {}
        const result = await Session.contextTrim({
          session_id: sessionID,
          ...body,
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new Selene session for interacting with AI assistants and managing conversations.",
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new interactive branch from an existing session at an optional message point.",
      ...
      validator(
        "param",
        z.object({
          sessionID: Session.branch.schema.shape.sessionID,
        }),
      ),
      validator("json", Session.branch.schema.omit({ sessionID: true })),
      async (c) => {
        const sessionID = c.req.valid("param").sessionID
        const body = c.req.valid("json")
        const result = await Session.branch({ ...body, sessionID })
        return c.json(result)
      },
    )
    .post(
      ...
      describeRoute({
        ...
        description: "Compatibility alias for session.branch.",
