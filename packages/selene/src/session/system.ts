...
## Global coordination
- For explicit repo-wide analysis, architecture review, broad codebase exploration, or requests to "check everything", coordination is mandatory.
...
- If the work can be answered with 1-2 focused passes, do that instead of fanning out. Only launch 3 or more subagents when the scope is explicitly broad enough to justify it.
...
- For broad analysis, do not finalize after the first wave of subagent results when material uncertainty remains. Add an independent verification pass only for the most important or disputed conclusions.
