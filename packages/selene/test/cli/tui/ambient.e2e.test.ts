...
const live = bin && process.env.SELENE_TUI_E2E === "1" ? test : test.skip
const cwd = "/Users/ref/dev/selene"
...
function setup(dir: string, mode: "empty" | "seeded") {
  const code = `
    import { Instance } from "./packages/selene/src/project/instance"
    import { Session } from "./packages/selene/src/session"
    import { TaskRun } from "./packages/selene/src/task/run"
    import { TaskBranch } from "./packages/selene/src/task/branch"
    import { Identifier } from "./packages/selene/src/id/id"
    import { Auth } from "./packages/selene/src/auth"
    import { Database } from "./packages/selene/src/storage/db"
