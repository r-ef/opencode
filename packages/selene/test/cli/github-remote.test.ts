...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/selene.git")).toEqual({ owner: "sst", repo: "selene" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/selene")).toEqual({ owner: "sst", repo: "selene" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/selene.git")).toEqual({ owner: "sst", repo: "selene" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/selene")).toEqual({ owner: "sst", repo: "selene" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/selene.git")).toEqual({ owner: "sst", repo: "selene" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/selene")).toEqual({ owner: "sst", repo: "selene" })
})
