...
import type { NamedError } from "@selene-ai/util/error"
...
describe("session.retry.delay", () => {
  test("bounds retry attempts for interactive sessions", () => {
    expect(SessionRetry.RETRY_MAX_ATTEMPTS).toBe(6)
  })
  ...
  test("caps retry-after values even when headers exceed the local retry budget", () => {
