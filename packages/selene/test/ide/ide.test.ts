...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders SELENE_CALLER", () => {
    process.env["SELENE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode SELENE_CALLER", () => {
    process.env["SELENE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown SELENE_CALLER", () => {
    process.env["SELENE_CALLER"] = "unknown"
