...
import { useLayout, LocalProject, showWorkspaces } from "@/context/layout"
import { useGlobalSync } from "@/context/global-sync"
import { Persist, persisted } from "@/utils/persist"
import { base64Encode } from "@selene-ai/util/encode"
import { decode64 } from "@/utils/base64"
import { ResizeHandle } from "@selene-ai/ui/resize-handle"
...
import { Session, type Message } from "@selene-ai/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@selene-ai/ui/toast"
import { useGlobalSDK } from "@/context/global-sdk"
import { clearWorkspaceTerminals } from "@/context/terminal"
import { useNotification } from "@/context/notification"
import { usePermission } from "@/context/permission"
import { Binary } from "@selene-ai/util/binary"
import { retry } from "@selene-ai/util/retry"
...
export default function Layout(props: ParentProps) {
  ...
  const show = (project: LocalProject | undefined) =>
    showWorkspaces({
      project,
      directory: currentDir(),
      enabled: !!project && layout.sidebar.workspaces(project.worktree)(),
    })

  const workspaceSetting = createMemo(() => {
    return show(currentProject())
  })
  ...
  const projectSidebarCtx: ProjectSidebarContext = {
    ...
    workspacesEnabled: (project) => show(project),
    workspaceIds,
    workspaceLabel,
    sessionProps: {
      sidebarExpanded,
  ...
  const SidebarPanel = (panelProps: { project: LocalProject | undefined; mobile?: boolean }) => {
    ...
    const workspacesEnabled = createMemo(() => show(panelProps.project))
        ...
        >
          <div class="@container w-full h-full contain-strict">
            <SidebarContent
              ...
              onOpenHelp={() => platform.openLink("https://selene.run/desktop-feedback")}
              renderPanel={() => (
