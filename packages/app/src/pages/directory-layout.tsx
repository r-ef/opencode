...
function DirectoryDataProvider(props: ParentProps<{ directory: string }>) {
  ...
  return (
    <DataProvider
      ...
      onNavigateToSession={(sessionID: string, directory?: string) => {
        const dir = directory ? base64Encode(directory) : params.dir
        navigate(`/${dir}/session/${sessionID}`)
      }}
      onSessionHref={(sessionID: string, directory?: string) => {
        const dir = directory ? base64Encode(directory) : params.dir
