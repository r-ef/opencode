...
export const dict = {
  ...
  "dialog.provider.selene.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.selene.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.seleneGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Selene tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Selene'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.seleneZen.line1":
    "Selene Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.seleneZen.visit.prefix": "",
  "provider.connect.seleneZen.visit.link": "selene.run/zen",
  "provider.connect.seleneZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Selene'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Selene'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler selene.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Selene sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Selene'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Selene ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (selene.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Selene henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Selene ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Selene Masaüstü",
  ...
  "settings.desktop.wsl.description": "Selene sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Selene'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Selene'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Selene'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Selene başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Selene'un en son sürümünü kullanıyorsunuz.",
