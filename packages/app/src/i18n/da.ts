export const dict = {
  ...
  "dialog.provider.selene.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.selene.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.seleneGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Selene",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Selene.",
  ...
  "provider.connect.seleneZen.line1":
    "Selene Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.seleneZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.seleneZen.visit.prefix": "Besøg ",
  "provider.connect.seleneZen.visit.link": "selene.run/zen",
  "provider.connect.seleneZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Selene.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Selene.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i selene.json",
  ...
  "dialog.server.description": "Skift hvilken Selene-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Selene ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Selene-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (selene.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Selene understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Selene inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Selene-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Selene",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Selene ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Selene er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Selene starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Selene.",
