export const dict = {
  ...
  "dialog.provider.selene.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.selene.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.seleneGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Selene",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Selene.",
  ...
  "provider.connect.seleneZen.line1":
    "Selene Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.seleneZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.seleneZen.visit.prefix": "Visite ",
  "provider.connect.seleneZen.visit.link": "selene.run/zen",
  "provider.connect.seleneZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Selene.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Selene.",
  ...
  "dialog.plugins.empty": "Plugins configurados em selene.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Selene este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Selene ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Selene",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (selene.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Selene ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Selene inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Selene dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Selene",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Selene aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Selene é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Selene iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Selene.",
