...
export const dict = {
  ...
  "dialog.provider.selene.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.selene.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.seleneGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Selene",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Selene.",
  ...
  "provider.connect.seleneZen.line1":
    "Selene Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.seleneZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.seleneZen.visit.prefix": "Besøk ",
  "provider.connect.seleneZen.visit.link": "selene.run/zen",
  "provider.connect.seleneZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Selene.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Selene.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i selene.json",
  ...
  "dialog.server.description": "Bytt hvilken Selene-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Selene ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Selene-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (selene.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Selene ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Selene inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Selene-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Selene",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Selene ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Selene er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Selene starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Selene.",
