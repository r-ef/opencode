export const dict = {
  ...
  "dialog.provider.selene.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.selene.tagline": "Reliable optimized models",
  "dialog.provider.seleneGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Selene",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Selene.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.seleneZen.line1":
    "Selene Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.seleneZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.seleneZen.visit.prefix": "Visit ",
  "provider.connect.seleneZen.visit.link": "selene.run/zen",
  "provider.connect.seleneZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Selene.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Selene.",
  ...
  "dialog.plugins.empty": "Plugins configured in selene.json",
  ...
  "dialog.server.description": "Switch which Selene server this app connects to.",
  ...
  "toast.update.description": "A new version of Selene ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Selene team",
  ...
  "error.chain.checkConfig": "Check your config (selene.json) provider/model names",
  ...
  "sidebar.gettingStarted.line1": "Selene includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "Change the display language for Selene",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Selene looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Selene is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Selene launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Selene.",
