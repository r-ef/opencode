export const dict = {
  ...
  "dialog.provider.selene.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.selene.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.seleneGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Selene",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Selene.",
  ...
  "provider.connect.seleneZen.line1":
    "Selene Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.seleneZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.seleneZen.visit.prefix": "Odwiedź ",
  "provider.connect.seleneZen.visit.link": "selene.run/zen",
  "provider.connect.seleneZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Selene.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Selene.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w selene.json",
  ...
  "dialog.server.description": "Przełącz serwer Selene, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Selene ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Selene",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (selene.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Selene does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Selene zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Run the Selene server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Selene",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Selene na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Selene.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Selene",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Selene.",
