export const dict = {
  ...
  "dialog.provider.selene.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.selene.tagline": "Modelos optimizados y fiables",
  "dialog.provider.seleneGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Selene",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Selene.",
  ...
  "provider.connect.seleneZen.line1":
    "Selene Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.seleneZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.seleneZen.visit.prefix": "Visita ",
  "provider.connect.seleneZen.visit.link": "selene.run/zen",
  "provider.connect.seleneZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Selene.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Selene.",
  ...
  "dialog.plugins.empty": "Plugins configurados en selene.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Selene se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Selene ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Selene",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (selene.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Selene no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Selene incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Selene dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Selene",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Selene en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Selene.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Selene",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Selene.",
