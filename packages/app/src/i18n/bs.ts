export const dict = {
  ...
  "dialog.provider.selene.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.selene.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.seleneGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Selene",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Selene-u.",
  ...
  "provider.connect.seleneZen.line1":
    "Selene Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.seleneZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.seleneZen.visit.prefix": "Posjeti ",
  "provider.connect.seleneZen.visit.link": "selene.run/zen",
  "provider.connect.seleneZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Selene-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Selene-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u selene.json",
  ...
  "dialog.server.description": "Promijeni na koji se Selene server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Selene-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Selene timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (selene.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Selene još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Selene uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Selene server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Selene-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Selene izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Selene-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Selene pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Selene-a.",
