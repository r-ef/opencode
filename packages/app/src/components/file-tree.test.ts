...
beforeAll(async () => {
  ...
  mock.module("@selene-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@selene-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@selene-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@selene-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
