...
import type {
  ...
  SessionBranchesErrors,
  SessionBranchesResponses,
  ...
  SessionContextReconcileErrors,
  SessionContextReconcileResponses,
...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new SeleneClient()" to fix this error.`)
    }
    return instance
  }
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global Selene configuration settings and preferences.
   */
   ...
   *
   * Update global Selene configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the Selene server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the Selene system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all Selene instances, releasing all resources.
   */
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with Selene.
   */
   ...
   * Get current project
   *
   * Retrieve the currently active project that Selene is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by Selene.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current Selene configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update Selene configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * Create session
   *
   * Create a new Selene session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific Selene session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
   ...
   *
   * Retrieve all subagent sessions owned by the specified parent session.
   */
   ...
   *
   * Retrieve all interactive sessions that share the same branch family and context root.
   */
  public branches<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<SessionBranchesResponses, SessionBranchesErrors, ThrowOnError>({
   ...
   *
   * Retrieve the shared-context cursor and publication status for a session within its root tree.
   */
   ...
   */
  public contextReconcile<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
      directory?: string
      workspace?: string
      sources?: Array<number>
      strategy?: "summary" | "winner" | "conflict"
      title?: string
      body?: string
      winner_context_id?: number
      ...
      [
        {
          args: [
            ...
            { in: "body", key: "title" },
            { in: "body", key: "body" },
            { in: "body", key: "winner_context_id" },
            { in: "body", key: "winner_session_id" },
            { in: "body", key: "keep_sources" },
          ],
        },
      ],
    )
    return (options?.client ?? this.client).post<
      ...
      ThrowOnError
    >({
      url: "/session/{sessionID}/context/reconcile",
      ...options,
      ...params,
      headers: {
        "Content-Type": "application/json",
   ...
   */
  public contextTrim<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
      directory?: string
      workspace?: string
    ...
    return (options?.client ?? this.client).post<SessionContextTrimResponses, SessionContextTrimErrors, ThrowOnError>({
      url: "/session/{sessionID}/context/trim",
      ...options,
      ...params,
      headers: {
        "Content-Type": "application/json",
   ...
   * Branch session
   *
   * Create a new interactive branch from an existing session at an optional message point.
   */
   ...
   * Fork session
   *
   * Compatibility alias for session.branch.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the Selene system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the Selene system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the Selene system.
   */
...
export class SeleneClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<SeleneClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    SeleneClient.__registry.set(this, args?.key)
  }
