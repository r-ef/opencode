...
export type EventSessionContextTrimmed = {
...
export type SessionListData = {
  ...
  query?: {
    ...
    workspace?: string
    /**
     * Only return interactive sessions (exclude subagents)
     */
    roots?: boolean
    /**
     * Filter sessions updated on or after this timestamp (milliseconds since epoch)
...
export type SessionBranchesData = {
  body?: never
  path: {
    sessionID: string
  }
...
export type SessionBranchesErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type SessionBranchesError = SessionBranchesErrors[keyof SessionBranchesErrors]

export type SessionBranchesResponses = {
  /**
   * List of branches
   */
  200: Array<Session>
...
export type SessionBranchesResponse = SessionBranchesResponses[keyof SessionBranchesResponses]
...
export type SessionContextStatusData = {
  ...
  query?: {
    ...
    workspace?: string
    /**
     * Optional source session to scope published stats
     */
    source_session_id?: string
    /**
     * Optional context kind filter for published stats
     */
    kind?: string
  }
...
export type SessionContextData = {
  ...
  query?: {
    ...
    workspace?: string
    /**
     * Return context entries strictly after this cursor id
     */
    after?: number
    /**
     * Maximum number of context entries to return
     */
    limit?: number
    /**
...
export type SessionContextReconcileErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type SessionContextReconcileError = SessionContextReconcileErrors[keyof SessionContextReconcileErrors]

export type SessionContextReconcileResponses = {
  /**
...
export type SessionContextReconcileResponse = SessionContextReconcileResponses[keyof SessionContextReconcileResponses]

export type SessionContextTrimData = {
  body?: {
    limit?: number
    buffer?: number
    force?: boolean
...
export type SessionContextTrimErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type SessionContextTrimError = SessionContextTrimErrors[keyof SessionContextTrimErrors]

export type SessionContextTrimResponses = {
  /**
   * Trim result
   */
  200: {
...
export type SessionContextTrimResponse = SessionContextTrimResponses[keyof SessionContextTrimResponses]
