...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/selene/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/selene...\n")
...
console.log("Fetching npm all-time downloads for selene-ai...\n")
const npmDownloads = await fetchNpmDownloads("selene-ai")
